...
when isMainModule:
  ...
  proc main(): void =
    ...
    echo "Send  1st:\t", "     \t", (st2[0]).ns, " +/-", 200.ns, "\t ", st2[1] , " tasks\t", "Time scheduling tasks"
    echo "Send  2nd:\t", "     \t", (nd2[0]).ns, " +/-", 200.ns, "\t ", nd2[1] , " tasks\t", "Time scheduling tasks"
    echo "Send  3rd:\t", "     \t", (rd2[0]).ns, " +/-", 200.ns, "\t ", rd2[1] , " tasks\t", "Time scheduling tasks"
    echo "Delay 1st:\t", "     \t", (st1[0]).ns, " +/-", 200.ns, "\t ", st1[1] , " tasks\t", "Time between sent and start running task"
    echo "Delay 2nd:\t", "     \t", (nd1[0]).ns, " +/-", 200.ns, "\t ", nd1[1] , " tasks\t", "Time between sent and start running task"
    echo "Delay 3rd:\t", "     \t", (rd1[0]).ns, " +/-", 200.ns, "\t ", rd1[1] , " tasks\t", "Time between sent and start running task"
